...
\section{EXPERIENCE} 
	{\sl Software Engineer} \hfill January 2016 - Present\\
		...
		\item Engineer on Loop, formerly adding location awareness to mobile applications (www.loop.ms)
		\item Currently experimenting with Bing ads (native ads on mobile)
